...
function BoardUserGroup({ boardUsers = [], limit = 4 }) {
  ...
  // Lưu ý ở đây chúng ta không dùng Component AvatarGroup của MUI bởi nó không hỗ trợ tốt trong việc chúng
  // ta cần custom & trigger xử lý phần tử tính toán cuối, đơn giản là cứ dùng Box và CSS - Style đám Avatar cho
  // chuẩn kết hợp tính toán một chút thôi.
  return (
