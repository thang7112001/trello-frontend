...
function AutoCompleteSearchBoard() {
  ...
  const handleInputSearchChange = (event) => {
    ...
    fetchBoardAPI(searchPath)
      ...
      .finally(() => {
        //setLoading(false) trong finally để dù có lỗi hay ko thì cũng ko hiện lại cái loading nữa
        setLoading(false)
      })
  }
  // bọc hàm  handleInputSearchChange ở trên vào useDebounce và cho delay khoảng 1s sau khi dừng gõ phím mới chạy api
  ...
  return (
    <Autocomplete
      ...
      // Options của Autocomplete nó cần đầu vào là 1 Array, mà boards của chúng ta ban đầu cần cho
      options={boards || []}
